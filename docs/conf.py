...
project = "SpaceAI"
copyright = str(datetime.now().year) + ", ContinualIST"
author = "ContinualIST"
...
html_context = {
    ...
    "github_user": "continualist",
    "github_repo": "space-ai",
    "github_version": "main",
    "doc_path": "docs",
}
...
external_links = [
    {
        "name": "Changelog",
        "url": "https://github.com/continualist/space-ai/blob/main/CHANGELOG.md",
    }
]
...
icon_links = [
    {
        "name": "GitHub",
        "url": "https://github.com/continualist/space-ai",
...
html_theme_options = {
    ...
    "logo": {
        "text": "SpaceAI",
        "alt_text": "SpaceAI - Home",
        "image_dark": "_static/images/logo.jpeg",
        "image_light": "_static/images/logo.jpeg",
    },
}
